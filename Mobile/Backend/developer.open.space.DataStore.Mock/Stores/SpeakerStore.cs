...
namespace developer.open.space.DataStore.Mock.Stores
{
    ...
    static class SampleData
    {
        ...
        static string[] mensNames = new string[]
            {
                "Robert Reif", "Siavash Ghassemi", "Wolfgang Kinkeldei", "Oliver Lorenz", "Adrian Weidermann",
                "Ferdinand Malcher", "Johannes Hoppe", "Timur Zanagar", "Philipp Dockhorn", "Hendrik Lösch",
                "Thomas Schissler", "Julian Steiner", "Sebastian Witalec", "Christoph Giebel", "Daniel Marbach",
                "Frank Pommerening", "Marco Richardson", "Marius Schulz", "Carsten König", "Erik Türke",
                "Maik Töpfer", "Marco Heimeshoff", "Robin Sedlaczek", "Alexander Witkowski", "Frank Lienhard"
            };

        static string[] womensNames = new string[]
            {
                "Edna Kropp", "Andrea Hauth", "Nina Hauer", "Ulrike Stirnweiß"
            };
