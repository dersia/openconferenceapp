...
namespace open.conference.app.Utils.Helpers
{
    ...
    public static class ApplicationDataConst
    {
        // Keys for ApplicationData
        public const string ApplicationDataCodeOfConduct = "CodeOfConduct";
        public const string ApplicationDataFloorMapsJsonUrl = "FoolMapsJsonUrl";
    }
}
