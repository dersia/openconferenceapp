...
namespace open.conference.app.Utils.Helpers
{
    /// <summary>
    ...
    public class Settings : INotifyPropertyChanged
    {
        ...
        readonly string WiFiSSIDDefault = "devopenspace";
        ...
        const string DevopenspaceCalendarIdKey = "devopenspace_calendar";
        static readonly string DevopenspaceCalendarIdDefault = string.Empty;
        public string DevopenspaceCalendarId
        {
            get { return AppSettings.GetValueOrDefault<string>(DevopenspaceCalendarIdKey, DevopenspaceCalendarIdDefault); }
            set { AppSettings.AddOrUpdateValue<string>(DevopenspaceCalendarIdKey, value); }
        }
        ...
        public readonly DateTime EndOfDevopenspace = new DateTime(2016, 4, 29, 0, 0, 0, DateTimeKind.Utc);
        ...
        public bool ShowPastSessions
        {
            get
            {
                //if end of Devopenspace
                if (DateTime.UtcNow > EndOfDevopenspace)
                    return true;
        ...
        const string ShowPastWorkshopsKey = "show_past_workshops";
        static readonly bool ShowPastWorkshopsDefault = false;

        /// <summary>
        /// Gets or sets a value indicating whether the user wants show past sessions.
        /// </summary>
        /// <value><c>true</c> if show past sessions; otherwise, <c>false</c>.</value>
        public bool ShowPastWorkshops
        {
            get
            {
                //if end of Devopenspace
                ...
                return AppSettings.GetValueOrDefault<bool>(ShowPastWorkshopsKey, ShowPastWorkshopsDefault);
            }
            set
            {
                if (AppSettings.AddOrUpdateValue<bool>(ShowPastWorkshopsKey, value))
                    OnPropertyChanged();
            }
        }
        ...
        public bool HasWorkshopFilters => (ShowPastWorkshops || FavoritesOnly || (!string.IsNullOrWhiteSpace(FilteredCategories) && !ShowAllCategories));
