...
using open.conference.app.iOS.Initializer;

using Social;
using open.conference.app.DataStore.Abstractions;
using Prism.Services;
using open.conference.app.DataStore.Mock.Helpers;
using Xamarin.Forms;
...
namespace open.conference.app.iOS
{
    ...
    public partial class AppDelegate : FormsApplicationDelegate
    {
        ...
        {
            public const string Tweet = "de.open.conference.app.tweet";
            public const string Announcements = "de.open.conference.app.announcements";
            public const string Events = "de.open.conference.app.events";
        }
