...
[assembly:ExportRenderer(typeof(SearchBar), typeof(DeveloperOpenSpaceSearchBarRenderer))]
namespace developer.open.space.Droid
{
    public class DeveloperOpenSpaceSearchBarRenderer : SearchBarRenderer
    {
        ...
        void UpdateCursorColor ()
        {
            ...
            try 
            {
                ...
                theField.Set(textView, Resource.Drawable.cursor_dark_grey);
