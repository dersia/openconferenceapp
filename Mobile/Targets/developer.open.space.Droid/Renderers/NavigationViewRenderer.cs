...
[assembly: ExportRenderer (typeof(developer.open.space.Clients.Views.Controls.NavigationView), typeof(NavigationViewRenderer))]
namespace developer.open.space.Droid
{
    public class NavigationViewRenderer : ViewRenderer<developer.open.space.Clients.Views.Controls.NavigationView, NavigationView>
    {
        NavigationView navView;
        ImageView profileImage;
        TextView profileName;
        protected override void OnElementChanged(ElementChangedEventArgs<developer.open.space.Clients.Views.Controls.NavigationView> e)
        {
            ...
            developer.open.space.Utils.Helpers.Settings.Current.PropertyChanged += SettingsPropertyChanged;
        ...
        {
            if (developer.open.space.Utils.Helpers.Settings.Current.IsLoggedIn)
                return;
        }

        void SettingsPropertyChanged (object sender, System.ComponentModel.PropertyChangedEventArgs e)
        {
            if (e.PropertyName == nameof(developer.open.space.Utils.Helpers.Settings.Current.Email))
            {
                UpdateName();
                UpdateImage();
            }
        ...
        void UpdateName()
        {
            profileName.Text = developer.open.space.Utils.Helpers.Settings.Current.UserDisplayName;
        }

        void UpdateImage()
        {
            Koush.UrlImageViewHelper.SetUrlDrawable (profileImage, developer.open.space.Utils.Helpers.Settings.Current.UserAvatar, Resource.Drawable.profile_generic);
        }
